...
##### _The IGC.plugin should work in a manner that it would connect all the member/users of the iHunt4 with the users in sub-databases and vice versa._
####
####
> Example, 
...
1.	**[signUp_to_IGC]**, this API will signUp new user directly into iHunt4 database, as well as in the sub-database of the app developer. In addition, to call this API it requires to pass following values,
```yaml
{
   “name”: “Eric”,
...
2.	**[login_to_IGC]**, calling this API requires passing of following credentials,
```yaml
{
   “email”: “eric@email.com”,
   “password”: “123123123”
...
<p align="center">
<img width="450" src="https://user-images.githubusercontent.com/15853904/139068050-854c3f95-4702-4d47-a6e5-2ae6e4e7d6d1.png" alt="IGCP 1 logo">
</p>
...
<p align="center">
<img width="450" src="https://user-images.githubusercontent.com/15853904/139068403-060e351b-a16d-498a-9ce6-b99e59f2de8f.png" alt="IGCP 2 logo">
</p>

3.	Upon Login new API-key and API-Secret will be generated for the developer on the dashboard.

<p align="center">
<img width="450" src="https://user-images.githubusercontent.com/15853904/139068511-d449fd2a-2a03-4df6-bc13-7ff066a51885.png" alt="IGCP 3 logo">
</p>
...
4.	If the developer is interested in granting users IGC tokens as rewards, he/she needs to “Login to IGC wallet”. 
...
<p align="center">
<img width="450" src="https://user-images.githubusercontent.com/15853904/139068619-32cba570-b767-45b5-a709-90a3fe78233b.png" alt="IGCP 4 logo">
</p>
...
<p align="center">
<img width="450" src="https://user-images.githubusercontent.com/15853904/139069061-86b8e6b3-305e-48b8-bab3-efa525482191.png" alt="IGCP 5 logo">
</p>
...
<p align="center">
<img width="450" src="https://user-images.githubusercontent.com/15853904/139069153-4286d44c-59fd-46a5-91e1-e77f17c9de77.png" alt="IGCP 6 logo">
</p>
...
7.	Developer will go to www.github.com/treasureDev/igcplugin and download the plugin for Unity games.
